...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: '[ADMIN] Tambah kategori baru' }),
...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'Lihat semua kategori (publik)' }),
...
__decorate([
    (0, common_1.Get)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Lihat detail kategori berdasarkan ID (publik)' }),
    (0, swagger_1.ApiParam)({ name: 'id', description: 'ID kategori', example: '1' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Detail kategori ditemukan' }),
...
__decorate([
    ...
    (0, common_1.Patch)(':id'),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: '[ADMIN] Update kategori berdasarkan ID' }),
    (0, swagger_1.ApiParam)({ name: 'id', description: 'ID kategori', example: '1' }),
    (0, swagger_1.ApiBody)({ type: create_category_dto_1.CreateCategoryDto }),
...
__decorate([
    ...
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: '[ADMIN] Hapus kategori berdasarkan ID' }),
    (0, swagger_1.ApiParam)({ name: 'id', description: 'ID kategori', example: '1' }),
